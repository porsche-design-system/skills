---
description: "Shared severity and role terminology for accessibility audits"
applyTo: "**/*.{md,agent.md}"
---
...
- Internal finding-reliability standards (see `a11y-finding-reliability.instructions.md`)
