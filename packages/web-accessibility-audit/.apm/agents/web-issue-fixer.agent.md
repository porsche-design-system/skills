...
For detailed browser verification patterns, see [Browser Tool Usage Guide](https://github.com/porsche-design-system/accessibility-agents/blob/main/docs/guides/browser-tool-usage.md).
